...
def main(cost_func, bounds, popsize, mutate, recombination, maxiter, init_param, w):
	...
	gen_sol = []
	gen_mem = []
	best_sol = cost_func(init_value, w, lsr, AI2, t)
	best_mem = init_value
	...
	for i in range(1,maxiter+1):
		...
		for j in range(0,popsize):
			...
			score_trial  = cost_func(v_trial, w, lsr, AI2, t)
			score_target = cost_func(x_t, w, lsr, AI2, t)
