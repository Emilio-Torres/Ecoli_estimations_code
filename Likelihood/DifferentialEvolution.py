...
def main(cost_func, bounds, popsize, mutate, recombination, maxiter, init_param, data):
	...
	gen_sol = []
	gen_mem = []
	best_sol = cost_func(init_value, data, AI2, lsr, t)
	best_mem = init_value
	...
	for i in range(1,maxiter+1):
		...
		for j in range(0,popsize):
	        ...
	        # Selection
			score_trial  = cost_func(v_trial, data, AI2, lsr, t)
			score_target = cost_func(x_t, data, AI2, lsr, t)
